...
import { sendAthleteThreadMessage } from "../actions";
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="sm" asChild>
          <Link href={"/athlete/messages" as Route}>← Inbox</Link>
        </Button>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Sending requires you to be a participant in this thread.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          <form
            action={sendAthleteThreadMessage}
